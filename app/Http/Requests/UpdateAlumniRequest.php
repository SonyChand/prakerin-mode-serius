...
class UpdateAlumniRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'foto' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2048', // Boleh kosong saat update
            'hasil_karya' => 'nullable|file|mimes:pdf,zip,doc,docx|max:5120', // Boleh kosong saat update
        ];
    }
}